...
VALUES
  ...
  (UUID(), 'user_id_of_Alice', 'Beachfront House', 'Beautiful house with ocean view.', 'Miami', 250.00, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
VALUES
  ...
  (UUID(), 'property_id_of_mountain_cabin', 'user_id_of_John', 5, 'The perfect getaway! Very cozy.', CURRENT_TIMESTAMP),
